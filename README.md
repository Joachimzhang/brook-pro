## 食用方法
```shell
wget -N --no-check-certificate https://mirror.ghproxy.com/https://raw.githubusercontent.com/Joachimzhang/brook-pro/main/brook.sh && chmod +x brook.sh && bash brook.sh
```
执行结果：
```
