...
Download_brook(){
    ...
    cd ${file}
    if [[ ${bit} == "x86_64" ]]; then
        wget --no-check-certificate -N "https://ghproxy.com/https://github.com/manfly17/brook-pro/releases/download/v20200801/brook"
    else
        wget --no-check-certificate -N "https://ghproxy.com/https://github.com/manfly17/brook-pro/releases/download/v20200801/brook_linux_386"
